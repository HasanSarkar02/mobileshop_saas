            ...
            <nav class="flex-1 p-3 space-y-0.5 overflow-y-auto">
                @php
                    $navLinks = [
                        ...
                        // Reports
                        ['route' => 'dashboard', 'label' => '— Reports —', 'd' => ''], // divider label trick
                        [
                            'route' => 'reports.pl',
                            'label' => 'P&L',
                            'd' =>
                        ...
                        [
                            ...
                            'label' => 'IMEI Ledger',
                            'd' => 'M12 4v1m6 11h2m-6 0h-2v4m0-11v3m0 0h.01M12 12h4.01M16 20h4',
                        ],
                        // Settings
                        [
                            'route' => 'settings',
