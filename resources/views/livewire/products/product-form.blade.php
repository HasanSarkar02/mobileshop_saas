<div class="max-w-3xl mx-auto space-y-5">
    @if ($showSuccessActions)
        <div class="card p-8 text-center space-y-4">
            ...
            <h3 class="text-lg font-semibold text-gray-900">Product Created!</h3>
            <p class="text-gray-500 text-sm">
                "{{ $name }}" has been added to your catalog. What would you like to do next?
            </p>
            <div class="flex flex-wrap gap-3 justify-center pt-2">
                <a href="{{ route('purchases.create', ['variant_ids' => implode(',', $createdVariantIds)]) }}"
                    wire:navigate class="btn-primary">
                    📦 Receive Stock Now
                </a>
                <a href="{{ route('products.show', $createdProductId) }}" wire:navigate class="btn-secondary">
                    View Product
                </a>
                <button wire:click="createAnother" class="btn-secondary">
                ...
                <fieldset class="space-y-4">
                    ...
                    <div>
                        ...
                        <input wire:model.live.debounce.400ms="name" type="text"
                            placeholder="e.g. Samsung Galaxy M12" class="input @error('name') input-error @enderror">
                        @error('name')
                        ...
                        <div>
                            ...
                            <div class="flex gap-2">
                                ...
                                <button type="button" wire:click="toggleBrandForm"
                                    class="btn-secondary btn-sm shrink-0" title="Add brand">
                                    +
                                </button>
                            </div>
                            @if ($showBrandForm)
                        ...
                        <div>
                            ...
                            <div class="flex gap-2">
                                ...
                                <button type="button" wire:click="toggleCategoryForm"
                                    class="btn-secondary btn-sm shrink-0" title="Add category">
                                    +
                                </button>
                            </div>
                            @if ($showCategoryForm)
                    ...
                    <div>
                        ...
                        @if ($product?->exists)
                            <p
                                class="mt-2 text-xs text-amber-600 bg-amber-50 border border-amber-200 rounded-lg px-3 py-2">
                            ...
                            <div class="border border-gray-200 rounded-xl p-4 space-y-3"
                                ...
                                <div class="grid sm:grid-cols-3 gap-3">
                                    <div>
                                        ...
                                        <p class="text-xs text-gray-400 mt-0.5">Blank = no variation (single variant)
                                        </p>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <input wire:model="variants.{{ $idx }}.min_stock_level"
                                ...
                                @if (!empty($variant['id']))
                                    <div class="flex items-center gap-2">
                                        <label class="flex items-center gap-2 text-xs text-gray-500 cursor-pointer">
                                            <input wire:model="variants.{{ $idx }}.is_active"
